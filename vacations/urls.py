...
urlpatterns = [
    ...
    url(r'^unapproved/$', views.UnapprovedVacationRequestView.as_view(), name='unapproved_request_list'),
    url(r'^create/$', views.CreateVacationRequestView.as_view(), name='create'),
